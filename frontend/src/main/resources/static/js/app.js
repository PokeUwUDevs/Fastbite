...
const SERVICES = {
    ...
    // En Docker, el frontend hace proxy a estos servicios
    // Las variables de entorno se inyectan desde docker-compose
    get userService() {
        return window.ENV?.SERVICES_USER || this.USER;
    },
    get restaurantService() {
        return window.ENV?.SERVICES_RESTAURANT || this.RESTAURANT;
    },
    get orderService() {
        return window.ENV?.SERVICES_ORDER || this.ORDER;
    }
};
...
const API = {
    ...
    // ==================== AUTH (User Service) ====================
    async register(data) {
        return this.request(SERVICES.userService, '/auth/register', {
            method: 'POST',
    ...
    async login(email, password) {
        return this.request(SERVICES.userService, '/auth/login', {
            method: 'POST',
            body: JSON.stringify({ email, password })
        });
    },

    // ==================== PRODUCTS (Restaurant Service) ====================
    async getProducts() {
        return this.request(SERVICES.restaurantService, '/products');
    },

    async getProduct(id) {
        return this.request(SERVICES.restaurantService, `/products/${id}`);
    },

    // ==================== ORDERS (Order Service) ====================
    async createOrder(data) {
        return this.request(SERVICES.orderService, '/orders', {
            method: 'POST',
            body: JSON.stringify(data)
        });
    },
    ...
    async getMyOrders() {
        return this.request(SERVICES.orderService, '/orders/my');
    },

    async getOrder(id) {
        return this.request(SERVICES.orderService, `/orders/${id}`);
    },

    async getKitchenOrders() {
        return this.request(SERVICES.orderService, '/orders/kitchen');
    },

    async updateOrderStatus(orderId, status) {
        return this.request(SERVICES.orderService, `/orders/${orderId}/status`, {
            method: 'PATCH',
            body: JSON.stringify({ status })
        });
    },

    // ==================== COMMENTS (Order Service) ====================
    async getComments(orderId) {
        return this.request(SERVICES.orderService, `/orders/${orderId}/comments`);
    },
...
const SSE = {
    ...
    connect(endpoint, onMessage, onError) {
        // SSE siempre va al Order Service
        const url = `${SERVICES.orderService}/api${endpoint}`;
...
// ==================== DEBUG ====================
console.log('FastBite Frontend Loaded');
